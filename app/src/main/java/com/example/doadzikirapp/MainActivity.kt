...
class MainActivity : AppCompatActivity() {
    ...
    // bulet2 penanda gambar ada dimana
    private lateinit var dotSlider: Array<ImageView?>

    // gambar artikel yang bisa digeser
    ...
    private fun initView() {
        ...
        llDzikirPagiPetang.setOnClickListener {
            startActivity(Intent(this, PagiPetangDzikir::class.java))
        }
