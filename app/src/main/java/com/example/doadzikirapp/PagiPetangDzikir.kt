...
class PagiPetangDzikir : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        when(v?.id){
            R.id.cv_dzikir_pagi -> startActivity(Intent(
                this, DzikirPagi::class.java))
            R.id.img_btn_dzikir_pagi -> startActivity(Intent(
                this, DzikirPagi::class.java))

            R.id.cv_dzikir_petang -> startActivity(Intent(
                this, DzikirPetang::class.java))
            R.id.img_btn_dzikir_petang -> startActivity(Intent(
                this, DzikirPetang::class.java))
        }
    }
